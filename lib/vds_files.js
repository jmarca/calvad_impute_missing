...
/**
 * check if the plots already exist in target
 * @param {} config
 * @param {} file
 * @param {} did
 * @param {} year
 ...
 * @returns {}
 */
function check_plots(config,file,did,year,done){
...
function vdsfile_handler_2(opt,trigger_R_job,doublecheck,callback){
     ...
     * @throws {}
     */
    function file_handler(ameliafiles){
    ...
    get_files(
        ...
        ,function(err,list){
            ...
            callback(null,file_handler(afiles))
            return null
        })
    return null
}
